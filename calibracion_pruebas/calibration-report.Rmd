...
gto_pan <- calibration_party(gto_2012, party = pan_na, frac = 0.075,
        stratum = distrito_loc_17, n_iter = 2500, n_burnin = 1000, 
...
calibration_gto <- calibration_prop(gto_2012, pri_pvem:otros,
        frac = 0.075, stratum = distrito_loc_17, n_iter = 3000, n_burnin = 1000, 
        n_chains = 1, seed = 1933, cl_cores = 6, n_rep = 400, 
...
calib_ratio <- parallel::mclapply(1:400, function(i) {
...
```{r b}
ggplot(filter(calib_ratio, n_sim <= 400), aes(x = n_sim, y = r, ymin = r - 2*std_error,
